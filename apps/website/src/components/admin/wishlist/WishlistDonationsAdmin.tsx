  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <p className="text-sm text-gray-500">PayPal orders and Neon CRM sync status</p>
                ...
                <tr key={d.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    ...
                    {d.paypalTransactionId && (
                      <p className="text-xs text-gray-400 mt-0.5 font-mono">{d.paypalTransactionId.slice(0, 12)}…</p>
                    )}
                  </td>
                  <td className="px-4 py-3">
                    {d.neonDonationId ? (
                      <span className="text-xs text-green-700">Logged #{d.neonDonationId}</span>
                    ) : d.status === "CAPTURED" ? (
