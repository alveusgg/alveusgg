...
const content: Record<MuralId, ReactNode> = {
  one: (
    <>
      <p className="text-lg">
        We&apos;re taking the Alveus approach to the wild, and with your help,
        we successfully raised $1,000,000 to fund the initial development of the
        Alveus Research & Recovery Institute. All 10,000 pixels on our mural
        have been unlocked by generous donors like you, each displaying the name
        of a vital original supporter of the institute.
      </p>

      <p className="text-lg">
        While all pixels have been claimed on this original mural, we heard you
        loud and clear that you want to keep supporting the institute and its
        mission. That&apos;s why we&apos;re excited to announce the launch of
        Pixel Project 2, a brand new mural with another 10,000 pixels waiting to
        be unlocked by generous donors like you.
      </p>
  ...
  two: (
    <>
      <p className="text-lg">
        If you didn&apos;t get a chance to support Alveus in developing the
        Alveus Research & Recovery Institute, taking the Alveus approach to the
        wild to help save species from extinction, now&apos;s your chance as
        we&apos;re bringing back the Pixel Project with a new mural. With your
        help, we can unlock another 10,000 pixels to further support the
        institute&apos;s initial development and launch our conservation
        breeding programs.
      </p>
