...
export const NotificationsButton = () => {
  return (
    <Popover as="div" className="relative flex items-center self-stretch">
      ...
      >
        <Popover.Panel className="absolute top-full right-0 z-30 -mt-0.5 flex w-[320px] max-w-[calc(80vw-50px)] flex-col gap-4 rounded border border-black/20 bg-alveus-green-900 p-4 text-gray-200 shadow-lg">
