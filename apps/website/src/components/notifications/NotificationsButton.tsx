  ...
  return (
    ...
    >
      ...
      <PopoverPanel
        ...
        className={classes(
          `
            absolute z-30 -mt-0.5 flex max-w-fit min-w-[240px] flex-col gap-0.5
            rounded-sm border border-black/20 bg-alveus-green-900 text-gray-200
            shadow-lg transition ease-in-out
            data-closed:scale-95 data-closed:opacity-0
            data-enter:duration-200
            data-leave:duration-75
            md:max-w-[calc(80vw-50px)]
          `,
