...
export const env = createEnv({
  server: {
    ...
    PUSH_BATCH_SIZE: z.number().int().min(1).default(10),
    PUSH_BATCH_DELAY_MS: z.number().int().min(1).default(2_000),
    PUSH_MAX_ATTEMPTS: z.number().int().min(1).default(5),
    PUSH_RETRY_DELAY_MS: z.number().int().min(1).default(10_000),
