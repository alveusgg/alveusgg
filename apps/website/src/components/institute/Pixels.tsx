...
import MyPixelPreview, {
  type MyPixelPreviewRef,
} from "@/components/institute/MyPixelPreview";
...
const Pixels = ({
  ...
  const myPixelRef = useRef<MyPixelPreviewRef>(null);
  ...
  const move = useCallback((e: MouseEvent) => {
    ...
    myPixelRef.current?.setPixel({ x, y });
  }, []);
