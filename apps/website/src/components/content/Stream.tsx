...
export const StreamPreview = ({
  ...
  <div className="relative aspect-video w-full">
    ...
    <img
      ...
      className={classes(
        `
          pointer-events-none aspect-video w-full bg-alveus-green-800
    ...
    {icon && (
      <>
        <div className="
          absolute inset-0 m-auto box-content aspect-10/7 w-20 rounded-2xl
...
export const StreamEmbed = ({
  ...
  return (
    <div className="flex h-full flex-col" ref={ref}>
      ...
      >
        <div className="
          absolute inset-0 -z-10 flex size-full flex-col justify-center
        ">
          {poster ? (
            <Image
              src={poster}
