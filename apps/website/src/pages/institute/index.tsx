          ...
          >
            <div className="flex grow flex-col items-start gap-4">
              ...
              <p className="text-lg text-balance">
                ...
                are excited to announce the launch of the Pixel Project 2! If
                you didn&apos;t get a chance to unlock a pixel on the original
                mural and become a permanent part of supporting the initial
                institute development, now is your chance to join us as continue
                fundraising to complete the initial development of the institute
                and launch our conservation breeding programs.
              </p>
